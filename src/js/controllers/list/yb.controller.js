...
(function(){
    ...
    angular
        .module('app')
        .controller('YbCtrl', YbCtrl);

    YbCtrl.$inject = ['$scope', '$state', '$stateParams', '$rootScope', 'dataService', '$timeout', '$ionicLoading'];
    function YbCtrl($scope, $state, $stateParams, $rootScope, dataService,  $timeout, $ionicLoading) {
        var vm = this;
